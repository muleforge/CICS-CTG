...
class CopyBookToXmlUtil {
     ...
     * @param copybookEncoding    The encoding of the binary data.
     * @param xsdFile     XSD file containing schema for output XML.
     * @param nameSpace   Namespace of the outbound Xml.
    ...
    protected void transform(InputStream copybookStream, String copybookEncoding, String xsdFile, XMLStreamWriter writer) throws Exception {
    	...
    	transform(copybookStream, copybookEncoding, xsdFile, nameSpace, writer);
    }
     ...
     * @param writer      writer to write XML.
     */
    protected void transform(InputStream copybookStream, String copybookEncoding, String xsdFile, String nameSpace, XMLStreamWriter writer) throws Exception {
